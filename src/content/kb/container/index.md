---
title: "Containers"
category: "OS, VMs & Containers"
draft: true
sourcePath: "docs/container/index.md"
---
...
![Container1](../_img/os_virt_tech.png)

## Bare Metal vs VM vs Container

![Container2](../_img/container_1.png)

## Docker Architecture

![Container3](../_img/container_2.png)
...
![OCI image spec visualization](../_img/oci-image-spec.png)
...
<html lang="en">
  ...
  <body>
    ...
    <p>
      This is a simple static website served by Nginx inside a Docker container.
    </p>
  </body>
</html>
```
