...
| Current role | Senior DevOps Engineer @ FullStackS GmbH (June 2022 – present)                                                    |
| Availability | Open to speaking & consulting engagements                                                                         |
| Focus        | DevOps, Cloud Native, Kubernetes, Supply Chain & Runtime Security, Platform Engineering, IaC                      |
| Community    | CNCF Ambassador · KCD Austria / Cloud Native Days organizer · Cloud Native Graz organizer                         |
| Teaching     | Lecturer at 2 Austrian universities of applied sciences                                                           |
| Recognition  | Sessionize "Most Active Speaker 2025" · Kubestronaut                                                              |
| Certs        | CNCF Ambassador (2025–2027) · Kubestronaut · PCA · OTCA · Certified in Cybersecurity (CC) · PSPO I (full list §9) |
| Track record | 30+ customers / companies                                                                                         |
| Education    | BSc Industrial Engineering · MA Innovation Management · MBA IT Management                                         |
| Website      | https://drackthor.me                                                                                              |
| GitHub       | https://github.com/DrackThor                                                                                      |
| Credly       | https://www.credly.com/users/drackthor                                                                            |

---

## 1. LinkedIn Headline (220 char max)
...
> First ~3 lines show before "…see more". Front-load the hook.
...
## 2b. German versions (DE)

> For a German-language LinkedIn variant or DACH audience.

**Headline (DE)**

> Senior DevOps Engineer @ FullStackS | CNCF Ambassador | Kubernetes, Platform- & Supply-Chain-Security | KCD/Cloud Native Days Organisator | Speaker & Lektor
...
> Keep EN + DE in sync when you edit one. LinkedIn supports a secondary-language profile (Settings → Account → Name, Location and Industry → add profile in another language).

---

## 3. Experience (achievement-oriented bullets)
...
- Co-built AVL's internal DevOps platform used by internal engineering teams.
...
- Operated a central regulatory Data Warehouse for the finance sector.
- Administered ETL and BI platforms and developed ETL jobs powering regulatory reporting.
- Owned information architecture for compliance-critical data pipelines.

---

## 4. Skills (pin the top 3)

**Pin these 3** (LinkedIn shows them first, weights search):
`Kubernetes` · `DevOps` · `Cloud Native / Platform Engineering`

**Full skills list to add:**
Kubernetes · DevOps · Cloud Native · Platform Engineering · Infrastructure as Code (Terraform/OpenTofu) · GitOps (Argo CD/Flux) · Ansible · CI/CD · Software Supply Chain Security · Container Security · Runtime Security · Policy as Code (OPA / Rego / cnspec) · SBOM & Artifact Signing · Helm · Linux · Automation · Cloud Architecture · Public Speaking · Technical Teaching · Agile · Scrum

> Skills that appear in your Featured talks + Experience get endorsement/search boost. Keep them consistent across sections.

---

## 5. Featured section (add these)
...
## 6. Signature Talks (for a "Speaking" highlight or website)
...
| Security as Code: From Rules to Reality                        | Policy with OPA, cnspec & admission controllers across infra/platform/app layers.              |
| Are You Compliant?                                             | Compliance frameworks, controls & evaluating cloud-native environments, with live demos.       |
| Linux (Pseudo)Filesystems: The Hidden Backbone of Cloud Native | procfs, sysfs, cgroupfs, overlayfs, tmpfs in containerized systems.                            |
| DevOps Done Right: RBAC                                        | RBAC principles, implementation & best practices across environment stages.                    |

Full track record (20+ talks) lives in `_config.yml` → Speaker Track Record.

---

## 7. Profile polish checklist

- [ ] Custom URL already set → linkedin.com/in/drackthor ✅ keep it.
- [ ] Banner image: cloud-native / speaking photo with name + tagline.
- [ ] Profile photo: professional, matches website (`images/daniel2hoch.jpg`).
- [ ] Open to: consulting / speaking (set "Open to work"/"Providing services" as fits).
- [ ] Turn on Creator mode → add topics: #CloudNative #Kubernetes #DevOps #Security #PlatformEngineering.
- [ ] Add Certifications section: marquee tier from §9 (CNCF Ambassador, Kubestronaut, PCA, OTCA, CC, PSPO I), link Credly.
- [ ] Add Education entries (all three degrees).
- [ ] Add Volunteering: CNCF Ambassador, KCD/Cloud Native Days & Cloud Native Graz organizer, university lecturing.
- [ ] Featured section populated (section 5).
- [ ] Contact info: website, email, GitHub, Sessionize.
...
## 9. Certifications & Badges (from Credly)
